...
int main(int argc, char * const argv[])
{
    ...
    R"(DemoCompiler Test Application.

    Usage:
      DemoCompilerTestApp  [--output-style=<style>] [--progress=<progress>] [--test=<test>] [--repeat=<count>]
      DemoCompilerTestApp  --list-all
      DemoCompilerTestApp  (-h | --help)
    ...
    try
    {
        args = docopt::docopt(USAGE,
                              ...
                              "DemoCompiler Test Application 1.0");     // Version string
    }
    catch (...)
    {
